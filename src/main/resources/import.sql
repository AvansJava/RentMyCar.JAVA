...
INSERT INTO car (brand, brand_type, model, license_plate_number, consumption, cost_price, created_at, car_type, location_id, user_id)
VALUES ('Honda', 'H-RV', 'EX-L', '465-HK-3', 5.7, 33450, CURRENT_TIMESTAMP, 'ICE', 1, 1),
       ('Volkswagen', 'Polo', '1.6 TDI', '4-YY-685', 4.45, 25960, CURRENT_TIMESTAMP, 'ICE', 2, 2),
       ('Hyundai', 'ix35', 'FCEV', '739-PD-2', 0.59, 27050, CURRENT_TIMESTAMP, 'FCEV', 3, 3),
       ('Peugeot', '208', 'e', '3-UP-869', 16.4, 28650, CURRENT_TIMESTAMP, 'BEV', 4, 4);
...
INSERT INTO product (created_at, price, status, insurance_type_id, insurance_price, rental_plan_id, reservation_number)
VALUES (CURRENT_TIMESTAMP, 1080.00, 'COMPLETED', 'ALL_RISK', 49.99, 1, 'GK7K6JDK2P'),
       (CURRENT_TIMESTAMP, 360.00, 'COMPLETED', 'ALL_RISK', 49.99, 1,'LC1KVDVIS0'),
       (CURRENT_TIMESTAMP, 720.00, 'COMPLETED', 'ALL_RISK_INTERNATIONAL', 69.99, 1, '1PWBX420XU'),
       (CURRENT_TIMESTAMP, 810.00, 'COMPLETED', 'BASIC_COVERAGE',29.99, 2, 'X7KNYDER0H'),
       (CURRENT_TIMESTAMP, 405.00, 'COMPLETED', 'BASIC_COVERAGE', 29.99, 3, 'PM5D26E9IF'),
       (CURRENT_TIMESTAMP, 1620.00, 'COMPLETED', 'BASIC_COVERAGE_INTERNATIONAL', 39.99, 4, '2IAUI1BU3E');

INSERT INTO payment (created_at, paid_at, payment_status, price, reservation_number, user_id, payment_method)
VALUES (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', 1129.99, 'GK7K6JDK2P', 5, 'IDEAL'),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', 409.99, 'LC1KVDVIS0', 6, 'IDEAL'),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', 789.99, '1PWBX420XU', 7, 'MASTER_CARD'),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', 839.99, 'X7KNYDER0H', 8, 'VISA_CARD'),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', 434.99, 'PM5D26E9IF', 9, 'IDEAL'),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', 1659.99, '2IAUI1BU3E', 10, 'PAYPAL');

INSERT INTO car_timeslot_availability (car_id, timeslot_id, rental_plan_id, start_at, product_id, end_at, status, created_at)
VALUES (1, 1, 1, '2022-11-01 07:00:00', 2, '2022-11-01 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 2, 1, '2022-11-01 12:00:00', 3, '2022-11-01 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 3, 1, '2022-11-01 17:00:00', 3, '2022-11-01 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 1, 1, '2022-11-02 07:00:00', NULL, '2022-11-02 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 2, 1, '2022-11-02 12:00:00', NULL, '2022-11-02 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 3, 1, '2022-11-02 17:00:00', NULL, '2022-11-02 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 1, 1, '2022-11-03 07:00:00', NULL, '2022-11-03 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 2, 1, '2022-11-03 12:00:00', NULL, '2022-11-03 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 3, 1, '2022-11-03 17:00:00', NULL, '2022-11-03 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 1, 2, '2022-12-01 07:00:00', NULL, '2022-12-01 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 2, 2, '2022-12-01 12:00:00', NULL, '2022-12-01 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 3, 2, '2022-12-01 17:00:00', NULL, '2022-12-01 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 1, 2, '2022-12-02 07:00:00', NULL, '2022-12-02 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 2, 2, '2022-12-02 12:00:00', NULL, '2022-12-02 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 3, 2, '2022-12-02 17:00:00', NULL, '2022-12-02 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 1, 2, '2022-12-03 07:00:00', 4, '2022-12-03 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 2, 2, '2022-12-03 12:00:00', 4, '2022-12-03 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (2, 3, 2, '2022-12-03 17:00:00', 4, '2022-12-03 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 1, 3, '2022-11-01 07:00:00', NULL, '2022-11-01 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 2, 3, '2022-11-01 12:00:00', NULL, '2022-11-01 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 3, 3, '2022-11-01 17:00:00', NULL, '2022-11-01 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 1, 3, '2022-11-02 07:00:00', NULL, '2022-11-02 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 2, 3, '2022-11-02 12:00:00', NULL, '2022-11-02 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 3, 3, '2022-11-02 17:00:00', NULL, '2022-11-02 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 1, 3, '2022-11-03 07:00:00', NULL, '2022-11-03 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 2, 3, '2022-11-03 12:00:00', NULL, '2022-11-03 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (3, 3, 3, '2022-11-03 17:00:00', 5, '2022-11-03 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 1, 4, '2022-11-01 07:00:00', 6, '2022-11-01 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 2, 4, '2022-11-01 12:00:00', 6, '2022-11-01 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 3, 4, '2022-11-01 17:00:00', 6, '2022-11-01 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 1, 4, '2022-11-02 07:00:00', 6, '2022-11-02 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 2, 4, '2022-11-02 12:00:00', 6, '2022-11-02 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 3, 4, '2022-11-02 17:00:00', 6, '2022-11-02 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 1, 4, '2022-11-03 07:00:00', NULL, '2022-11-03 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 2, 4, '2022-11-03 12:00:00', NULL, '2022-11-03 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (4, 3, 4, '2022-11-03 17:00:00', NULL, '2022-11-03 21:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 1, 1, '2022-10-02 07:00:00', 1, '2022-10-02 11:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 2, 1, '2022-10-02 12:00:00', 1, '2022-10-02 16:30:00', 'OPEN', CURRENT_TIMESTAMP),
       (1, 3, 1, '2022-10-02 17:00:00', 1, '2022-10-02 21:30:00', 'OPEN', CURRENT_TIMESTAMP);
