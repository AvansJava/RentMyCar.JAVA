...
INSERT INTO payment (created_at, paid_at, payment_status, is_payout, price, reservation_number, user_id)
VALUES (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', false, 1129.99, 'GK7K6JDK2P', NULL),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', false, 409.99, 'LC1KVDVIS0', NULL),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', false, 789.99, '1PWBX420XU', NULL),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', false, 839.99, 'X7KNYDER0H', NULL),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', false, 434.99, 'PM5D26E9IF', NULL),
       (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SUCCESS', false, 1659.99, '2IAUI1BU3E', NULL);
