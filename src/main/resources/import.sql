...
INSERT INTO car (brand, brand_type, model, license_plate_number, consumption, cost_price, created_at, car_type, location_id,user_id, image_path)
VALUES ('Honda', 'H-RV', 'EX-L', '465-HK-3', 5.7, 33450, CURRENT_TIMESTAMP, 'ICE', 1, 1, 'E:\storage\fd2ae4e6-e6c3-494c-a2a7-3f63764b68f5.jpg'),
       ('Volkswagen', 'Polo', '1.6 TDI', '4-YY-685', 4.45, 25960, CURRENT_TIMESTAMP, 'ICE', 2, 2, 'E:\storage\3792f7ab-6d3f-4b62-bec8-0096e273c910.jpg'),
       ('Hyundai', 'ix35', 'FCEV', '739-PD-2', 0.59, 27050, CURRENT_TIMESTAMP, 'FCEV', 3, 3, 'E:\storage\e694126c-107e-4111-9d67-cfe39588ef3a.jpg'),
       ('Peugeot', '208', 'e', '3-UP-869', 16.4, 28650, CURRENT_TIMESTAMP, 'BEV', 4, 4, 'E:\storage\de093bb3-2dab-4015-bcfc-9c547555be11.jpg');
